...
**Current version: 0.7.13** (released 2026-05-24). Fix Deathdealer double-application on Righteous Fury hits. Full personal combat math audit — all formulas verified correct.
