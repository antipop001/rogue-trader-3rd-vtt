...
**Current version: 0.7.27** (released 2026-06-05). **Portrait-bust reframe pass** — 223 portraits flagged by the framing audit re-generated at 1024×1024 with explicit head-and-shoulders prompt. Framing GOOD count went 54 → **190**; FACE_TINY 197 → 53. Every NPC still has a portrait (no regressions from the framing rerun).
