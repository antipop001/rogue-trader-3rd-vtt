...
**Current version: 0.7.21** (released 2026-05-27). Fix armour display (remove TB from AP total), Parry uses full WS at advance 0, remove craftsmanship bonuses from Parry rolls.
