...
**Current version: 0.7.29** (released 2026-06-08). **Style-unify pass across all 334 NPC portraits.** New `tools/npc_pipeline/comfy_npc_stylize.py` re-renders each existing portrait via img2img at denoise 0.30 with only the Oldhammer LoRA @ 0.55 + a fixed FFG/Blanche/Kopinski oil-paint prompt. Composition and face preserved; palette, lighting, and brushwork unified across the whole compendium. 100.3 min, 0 errors.
