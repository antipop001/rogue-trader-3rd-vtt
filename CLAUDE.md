...
**Current version: 0.7.6** (released 2026-05-22). Three-part talent mechanics overhaul. 4 always-on talents (Machinator Array / Master Chirurgeon / Hotshot Pilot / Infused Knowledge) now carry transferable ActiveEffects that auto-modify characteristic / skill modifiers. 10 pick-at-acquisition talents (Talented, Hatred, Peer, Good Reputation, Enemy, Rival, Weapon Master, Exotic Weapon Training, Psychic Technique, Warp Eye) prompt a DialogV2 picker on drag-drop and lock the choice into `system.choice` + the item name. 23 conditional-bonus talents surface as opt-in checkboxes in the skill/characteristic roll dialog (Berserk Charge, Frenzy, Hatred, Peer, Resistance variants, Iron Discipline, Void Tactician, etc.).
