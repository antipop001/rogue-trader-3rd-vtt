...
**Current version: 0.7.12** (released 2026-05-24). Psychic power math fixes: remove DH2 PR modifier from Focus Power Test, fix Telekinetic Weapon and Force Shards penetration to @pr.
