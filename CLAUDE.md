...
**Current version: 0.7.28** (released 2026-06-07). **Manual NO_FACE portrait swap.** User reviewed all 81 NO_FACE portraits flagged by the framing audit and dropped in 21 hand-picked replacements (the rest validated as fine — creatures/xenos where Haar can't detect a face but the art is correct). Re-audit: GOOD 190 → **193**, NO_FACE 81 → 62.
