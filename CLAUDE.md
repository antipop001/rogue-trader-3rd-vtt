...
**Current version: 0.7.10** (released 2026-05-24). Fix Guarded Action (was missing -10 modifier and Attack subtype — never appeared in weapon attack prompt) and Overwatch (was missing -20 BS modifier). Found via comprehensive combat rules audit against RT Core.
