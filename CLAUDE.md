...
**Current version: 0.7.23** (released 2026-05-30). Psychic-powers audit pass against RT Core / Into the Storm — 8 P0 data corrections (Puppet Master cost 500→300; Force Bolt / Telekinetic Crush / Telekinetic Weapon / Force Shards / Storm of Force damage per-PR multipliers reduced to canon; Psychic Scream `penetration: 99` sentinel → 0; Thought Sending range 10m→1km × PR) + 33 prereq fields populated from canon + Mind's Eye reclassified as passive (action/sustained N/A).
