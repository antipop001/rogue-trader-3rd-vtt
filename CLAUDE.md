...
**Current version: 0.7.17** (released 2026-05-26). Split DH2 consolidated skills back to RT 1e canon: athletics→climb+swim, stealth→concealment+silentMove+shadowing, linguistics→speakLanguage+secretTongue+ciphers+literacy. Skill count 32→38.
