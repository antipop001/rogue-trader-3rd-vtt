...
**Current version: 0.7.8** (released 2026-05-24). Compendium data audit across weapons, cybernetics, and armour. 40 weapon fixes (systematic Inaccurate/Unreliable/Unbalanced flag inversion from build-script substring bug, Storm Bolter rebuild, individual stat corrections). Cybernetics availability values corrected (all 30 were schema-default "common"), armour-point wiring added to Bionic Heart/Cranial Armour/Subskin Armour, three missing corebook cybernetics added. Armour fixes for Squighide AP, Blurshield description/type, Eldar Forceshield weight.
