...
**Current version: 0.7.5** (released 2026-05-20). 13 Career Special Abilities added to the talents pack (Exceptional Leader, Weapon Master, Soul-Bound to the Emperor, See Without Eyes, Explorator Implants, Warp Eye, The Boons of Lineage, Navigator Mutations, Seeker of Lore, plus the four Void-master Masteries). Pack count goes 195 → 208.
