...
**Current version: 0.7.24** (released 2026-06-05). New **Guides** compendium with a player-facing **Character Entry Guide** JournalEntry (10 pages, one per sheet tab + a rolls/combat reference). DH-flavored "Acolyte" purged from all player-facing prose; sheet referred to as Explorer per RT terminology.
