...
const SKILL_LABELS = {
    ...
    barter: "Barter", blather: "Blather",
    carouse: "Carouse", charm: "Charm", chemUse: "Chem-Use",
    ciphers: "Ciphers", climb: "Climb", command: "Command",
    commerce: "Commerce", commonLore: "Common Lore",
    concealment: "Concealment", contortionist: "Contortionist",
    deceive: "Deceive", demolitions: "Demolitions",
    disguise: "Disguise", dodge: "Dodge", drive: "Drive",
    evaluate: "Evaluate", forbiddenLore: "Forbidden Lore",
    gamble: "Gamble", inquiry: "Inquiry",
    interrogation: "Interrogation", intimidate: "Intimidate",
    invocation: "Invocation", literacy: "Literacy",
    logic: "Logic", medicae: "Medicae", navigate: "Navigate",
    parry: "Parry", performance: "Performance", pilot: "Pilot",
    psyniscience: "Psyniscience", scholasticLore: "Scholastic Lore",
    scrutiny: "Scrutiny", search: "Search",
    ...
    tracking: "Tracking", trade: "Trade", wrangling: "Wrangling",
};
